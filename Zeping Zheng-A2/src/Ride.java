    ...
    public void exportRideHistory(String filename) {
        ...
        try {
            ...
            for (Visitor visitor : rideHistory) {
                String line = visitor.getName() + "," + visitor.getAge() + "," + visitor.getAddress()+","+visitor.getTicketType()+","+visitor.isHasFastPass();
                writer.write(line);
                writer.newLine();
            }
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (data.length == 5) {
                    ...
                    boolean hasFastPass = Boolean.parseBoolean(data[4]);
                    Visitor visitor = new Visitor(name, age, address, ticketType, hasFastPass);
                    rideHistory.add(visitor);
                    System.out.println("Visitor " + name + " has been added to the ride history.");
                } else {
